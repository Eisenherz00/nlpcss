"""Individual evaluation checks — one function per criterion.

Each check_xxx() function takes an item dict (and optionally gold data)
and returns a result dict with keys: passed, value, detail, caro_ref, status.
"""

import re
from typing import Any, List, Optional

from src.evaluator.lexicon import (
