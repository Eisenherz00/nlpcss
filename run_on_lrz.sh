...
rsync -avz --exclude '.venv' --exclude '__pycache__' --exclude '.DS_Store' --exclude 'outputs' \
  /Users/mf/Desktop/Projects/seminar/ lrz:~/seminar/ > /dev/null
...
mkdir -p /Users/mf/Desktop/Projects/seminar/outputs
rsync -avz lrz:~/seminar/outputs/ /Users/mf/Desktop/Projects/seminar/outputs/ > /dev/null
